...
@InputType()
class ReservationCreateNestedManyWithoutPassengersInput {
...
export { ReservationCreateNestedManyWithoutPassengersInput as ReservationCreateNestedManyWithoutPassengersInput };
